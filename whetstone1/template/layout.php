...
<html><head>
		...
		<script type="text/javascript" src="../js/jquery-ui-1.8.17/js/jquery-ui-1.8.17.custom.min.js"></script>
		<script type="text/javascript" src="../js/jlayout.border.min.js"></script>
	...
	<body>
		<div class="layout {layout: {type: 'border', hgap: 3, vgap: 3}}">
			...
			<div class="north">
                <a class='cursive' id='review' href='../members/addVerse.php'>Add Verse</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
